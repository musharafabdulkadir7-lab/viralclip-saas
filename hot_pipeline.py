...
def prebake_clip_worker(niche: str, is_free_tier: bool = False):
    ...
    try:
        ...
        if dl.get("sub_path"):
            ...
            clip_info = {"start_sec": 60, "end_sec": 180, "caption": niche.upper(), "num_parts": 2}
        ...
        print(f"[HotPipeline] Hot clip successfully pre-baked and ready in cache! ({len(clip_paths)} parts)")
